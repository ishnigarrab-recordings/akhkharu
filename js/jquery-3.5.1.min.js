/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
	...
	$(document).ready(function(){
		$("#link-page-top").click(function() {
			if($("#about").css("display") == "block") {
				$("#about").fadeOut(2000);
				$("#footer-tag-main").delay(1000).fadeIn(3000);
			}
			if($("#project").css("display") == "block") {
				$("#project").fadeOut(2000);
				$("#footer-tag-main").delay(9000).fadeIn(3000);
			}
			if($("#nav-bg").css("display") == "block") {
			$("#nav-bg").fadeOut(1500);	
			}
			if($("#link-page-top").css("display") == "block") {
			}
		});
